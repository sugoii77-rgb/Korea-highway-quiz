    ...
    "seoul-busan": [
        {
            ...
            details: [
                ...
                { step: "경유", description: "수원IC → 천안IC → 대전IC → 대구IC 통과" },
                { step: "도착", description: "부산IC 도착" }
            ]
        },
        {
            id: 2,
            ...
            details: [
                ...
                { step: "환승", description: "여주IC → 중부내륙고속도로 환승" },
                { step: "경유", description: "충주 → 안동 → 대구 통과" },
    ...
    "seoul-gwangju": [
        {
            ...
            details: [
                { step: "출발", description: "서울 → 경부고속도로 진입" },
                { step: "환승", description: "논산JC → 호남고속도로 환승" },
    ...
    "seoul-gangneung": [
        {
            ...
            details: [
                { step: "출발", description: "서울 → 영동고속도로 진입" },
                { step: "경유", description: "하남IC → 여주IC → 원주IC → 평창IC 통과" },
                { step: "도착", description: "강릉IC 도착" }
            ]
        }
    ],
    "seoul-daegu": [
    ...
    displayRouteOptions(routes) {
        ...
        if (routeListDiv) {
            ...
            routes.forEach((route, index) => {
                ...
                routeDiv.innerHTML = `
                    <h4>${route.name}</h4>
                    <p>📏 거리: ${route.distance} | ⏱️ 소요시간: ${route.time}</p>
                    <p>🛣️ 경유: ${route.highways.join(' → ')}</p>
                `;
